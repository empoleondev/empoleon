...
const cssCode = `
.root {
  border-top-left-radius: var(--empoleon-radius-xl);
  border-bottom-left-radius: var(--empoleon-radius-xl);
  padding-left: 4px;
...
function SendFilesButton(props: ButtonProps & JSX.ButtonHTMLAttributes<HTMLButtonElement>) {
  return <Button {...props} radius="md" classNames={classes} />;
}
