import { Box, Button, Group, Paper, Text } from '@empoleon/core';
import { useScrollIntoView } from '@empoleon/hooks';
import { EmpoleonDemo } from '@empoleonx/demo';

const code = `
import { useScrollIntoView } from '@empoleon/hooks';
import { Button, Text, Group, Paper, Box } from '@empoleon/core';
...
function Demo() {
  ...
  return (
    <Group justify="center">
      <Paper ref={scrollableRef} h={150} w={300} style={{ 'overflow-x': 'scroll' }}>
        <Box pl={260} pr={450}>
          <Paper
            ref={targetRef}
            p="md"
...
export const useScrollIntoViewAxis: EmpoleonDemo = {
  type: 'code',
  code,
  component: Demo,
};
