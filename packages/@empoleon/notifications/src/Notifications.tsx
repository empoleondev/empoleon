...
//   // Create the list transition
//   const transitionResult = createListTransition(notificationRefs, {
//     appear: true,
...
//             // Start as tiny ball at the corner/edge where it will appear from
//             let startTransform;
//             if (isRight) {
//               // Start tiny at far right edge
//               startTransform = 'translateX(200px) scale(0.1)';
//             } else if (isLeft) {
//               // Start tiny at far left edge
//               startTransform = 'translateX(-200px) scale(0.1)';
//             } else if (isTop) {
//               // Start tiny at top edge
//               startTransform = 'translateY(-200px) scale(0.1)';
//             } else if (isBottom) {
//               // Start tiny at bottom edge
//               startTransform = 'translateY(200px) scale(0.1)';
//             } else {
//               // Default center
...
//             // Apply initial state - tiny ball
//             el.style.transform = startTransform;
//             el.style.opacity = '1'; // Visible from start
//             el.style.willChange = 'transform';

//             // Force reflow
//             void el.offsetHeight;

//             // Set up transition with bounce at the end
//             el.style.transition = `transform ${props.duration}ms cubic-bezier(0.51, 0.3, 0, 1.21)`;
