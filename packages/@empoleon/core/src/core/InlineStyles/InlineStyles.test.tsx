...
describe('@empoleon/core/InlineStyles', () => {
  ...
  it('renders media styles', () => {
    ...
    const styleElement = container.querySelector('[data-empoleon-styles="inline"]');
    expect(styleElement).toBeInTheDocument();
    expect(styleElement!.innerHTML).toBe('body{color:red;}@media(min-width:500px){body{color:blue;}}');
  });
  ...
  it('renders container styles', () => {
    ...
    const styleElement = container.querySelector('[data-empoleon-styles="inline"]');
    expect(styleElement).toBeInTheDocument();
    expect(styleElement!.innerHTML).toBe('body{color:red;}@container aside (min-width:500px){body{color:blue;}}');
  });
});
