...
describe('@empoleon/core/Popover', () => {
  ...
  it('correctly handles withArrow={true}', () => {
    ...
    expect(container.querySelectorAll('.empoleon-Popover-arrow')).toHaveLength(1);
  });

  it('correctly handles withArrow={false}', () => {
    const { container } = render(() => <TestContainer defaultOpened withArrow={false} />);
    expect(container.querySelectorAll('.empoleon-Popover-arrow')).toHaveLength(0);
  });
