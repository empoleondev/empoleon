...
const getInputWrapper = (element: HTMLElement) => element.querySelector('.empoleon-Input-wrapper')!;

describe('@empoleon/core/Input', () => {
  tests.axe([
  ...
  tests.itSupportsSystemProps<InputProps, InputStylesNames>({
    ...
    polymorphicSelector: '.empoleon-Input-input',
    displayName: '@empoleon/core/Input',
