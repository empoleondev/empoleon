...
const clickIncrement = (container: HTMLElement) =>
  userEvent.click(container.querySelector('.empoleon-NumberInput-control[data-direction="up"]')!);

const clickDecrement = (container: HTMLElement) =>
  userEvent.click(container.querySelector('.empoleon-NumberInput-control[data-direction="down"]')!);
...
describe('@empoleon/core/NumberInput', () => {
  tests.axe([
