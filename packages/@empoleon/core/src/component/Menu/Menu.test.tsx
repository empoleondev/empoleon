...
describe('@empoleon/core/Menu', () => {
  ...
  it('correctly handles withArrow={true}', () => {
    ...
    expect(document.querySelectorAll('.empoleon-Menu-arrow')).toHaveLength(1);
  });

  it('correctly handles withArrow={false}', () => {
    render(() => <TestContainer defaultOpened withArrow={false} />);
    expect(document.querySelectorAll('.empoleon-Menu-arrow')).toHaveLength(0);
  });
  ...
  it('has correct displayName', () => {
    expect(Menu.displayName).toEqual('@empoleon/core/Menu');
  });
