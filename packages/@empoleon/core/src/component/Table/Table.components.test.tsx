...
describe('@empoleon/core/Table', () => {
  ...
  describe('TableTh', () => {
    ...
    //   displayName: '@empoleon/core/TableTh',
    //   selector: 'th',
    //   stylesApiName: 'Table',
  ...
  describe('TableTd', () => {
    ...
    //   id: true,
    //   refType: HTMLTableCellElement,
    //   displayName: '@empoleon/core/TableTd',
    //   selector: 'td',
    //   stylesApiName: 'Table',
  ...
  describe('TableTr', () => {
    ...
    //   displayName: '@empoleon/core/TableTr',
    //   selector: 'tr',
    //   stylesApiName: 'Table',
  ...
  describe('TableThead', () => {
    ...
    //   displayName: '@empoleon/core/TableThead',
    //   selector: 'thead',
    //   stylesApiName: 'Table',
  ...
  //     id: true,
  //     refType: HTMLTableSectionElement,
  //     displayName: '@empoleon/core/TableTbody',
  //     selector: 'tbody',
  //     stylesApiName: 'Table',
  ...
  //     id: true,
  //     refType: HTMLTableSectionElement,
  //     displayName: '@empoleon/core/TableTfoot',
  //     selector: 'tfoot',
  //     stylesApiName: 'Table',
  ...
  describe('TableCaption', () => {
    ...
    //   displayName: '@empoleon/core/TableCaption',
    //   selector: 'caption',
    //   stylesApiName: 'Table',
