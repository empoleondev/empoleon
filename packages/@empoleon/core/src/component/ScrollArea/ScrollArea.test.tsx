...
describe('@empoleon/core/ScrollArea', () => {
  tests.itSupportsSystemProps<ScrollAreaProps, ScrollAreaStylesNames>({
    ...
    displayName: '@empoleon/core/ScrollArea',
    stylesApiSelectors: ['root', 'viewport'],
  });
});

describe('@empoleon/core/ScrollAreaAutosize', () => {
  tests.itSupportsSystemProps<ScrollAreaProps, ScrollAreaStylesNames>({
    ...
    classes: true,
    refType: HTMLDivElement,
    displayName: '@empoleon/core/ScrollAreaAutosize',
  });
});
