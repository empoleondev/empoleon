import { createMemo, createSignal, Index, JSX, splitProps } from 'solid-js';
import { clamp, useId, useMergedRef, useUncontrolled } from '@empoleon/hooks';
import {
  Box,
  BoxProps,
  createVarsResolver,
...
Rating.displayName = '@empoleon/core/Rating';
