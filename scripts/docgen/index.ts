import { generateDeclarations } from 'empoleon-docgen-script';
import { getPath } from '../utils/get-path';
import { DOCGEN_PATHS } from './docgen-paths';

generateDeclarations({
  tsConfigPath: getPath('tsconfig.json'),
  outputPath: getPath('apps/empoleon.dev/src/.docgen'),
  ...
  typesReplacement: {
    ...
    '[DefaultEmpoleonColor, DefaultEmpoleonColor] | undefined': '[EmpoleonColor, EmpoleonColor]',
